...
public class Project extends BaseEntity{
    ...
    public Project(long id, LocalDateTime insertDateTime, long insertUserId, LocalDateTime lasUpdateDateTime,
        ...
        super(id, insertDateTime, insertUserId, lasUpdateDateTime, lastUpdateUserId);
